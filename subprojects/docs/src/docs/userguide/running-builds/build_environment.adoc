...
The final configuration taken into account by Gradle is a combination of all your `gradle.properties` files. If an option is configured in multiple locations, the _first one_ found in any of these locations wins:
